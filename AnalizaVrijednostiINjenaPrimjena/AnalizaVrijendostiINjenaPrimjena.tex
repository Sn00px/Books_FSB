...
\begin{tabular}[c]{@{}l@{}}4. Određivanje alternativnih rješenja\\ 4.1. Istraživanje svih mogućih rješenja.\end{tabular}                                                                                  & \begin{tabular}[c]{@{}l@{}}Koje bi drugo riješenje zadovoljavalo\\ traženu funkciju?\end{tabular}     \\ \hline
...
\begin{tabular}[c]{@{}l@{}}6. Izbor optimalnog rješenja, prijedlog i realizacija\\ 6.1. Izbor optimalnog rješenja.\\ 6.2. Izrada prijedloga.\\ 6.3. Ostvarivanje prijedloga.\end{tabular}                  &                                                                                                       \\ \hline
\end{tabular}
\end{table}
\FloatBarrier
Odgovori na postavljena pitanja su odgovori analize vrijednosti i to je ono što čini analizu vrijednosti različitom od drugih metoda, odnosno sistema za iznalaženje optimalnih rješenja.\\ 
...
14. Dali je kod toga uopće potrebno odviti vijak?                                                    & \begin{tabular}[c]{@{}l@{}}Probama na pećima je konstatirano: \\ VIJAK NE TREBA OTPUSTITI!\\ Naime, pritiskom na gornji ili\\ donji dio okvira, zaklopka se \\ može postaviti u željeni položaj, bez\\ otpuštanja vijka. Konstatacija:\\ VIJAK NEMORA IMATI OVAKAV\\ OBLIK GLAVE\end{tabular} \\ \hline
\end{tabular}
\end{table}
\FloatBarrier
