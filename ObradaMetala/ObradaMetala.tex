...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.15]{image_17.png}
\end{figure}
\FloatBarrier
\section{Tokarenje}
...
\multicolumn{1}{l}{}                                                                             & \multicolumn{1}{l}{}                    & \multicolumn{1}{l}{}                & \multicolumn{1}{l|}{}                                                     & \multicolumn{6}{c|}{Posmak (mm/ok)}       \\ \cline{5-10} 
                                                                                                 &                                         &                                     &                                                                           & \multicolumn{6}{c|}{Promjer svrdla (mm)}     \\ \hline
\multicolumn{1}{|c|}{Materijal svrdla}                                                           & \multicolumn{1}{c|}{Rashladno sredstvo} & \multicolumn{1}{c|}{Brzina rezanja} & Brušeni materijal                                                        & 5    & 8    & 12   & 16   & 25   & 40   \\ \hline
\multicolumn{1}{|c|}{\multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Alatni\\ čelik\end{tabular}}}    & \multicolumn{1}{c|}{Sapunica}           & \multicolumn{1}{c|}{10-18 (m/min)}          & \begin{tabular}[c]{@{}c@{}}čelik do \\ 50 kp/mm$^{2}$\end{tabular}             & 0,09 & 0,12 & 0,16 & 0,18 & 0,2  & 0,22 \\ \cline{2-10} 
\multicolumn{1}{|c|}{}                                                                           & \multicolumn{1}{c|}{Sapunica} & \multicolumn{1}{c|}{9-12 (m/min)}           & \begin{tabular}[c]{@{}c@{}}čelik iznad\\ 50 kp/mm$^{2}$\end{tabular}           & 0,08 & 0,11 & 0,14 & 0,16 & 0,18 & 0,2  \\ \cline{2-10} 
\multicolumn{1}{|c|}{}                                                                           & \multicolumn{1}{c|}{Suho}               & \multicolumn{1}{c|}{8-14 (m/min)}           & \begin{tabular}[c]{@{}c@{}}lijevano\\ željezo\\ do 18 kp/mm$^{2}$\end{tabular} & 0,12 & 0,18 & 0,22 & 0,25 & 0,3  & 0,35 \\ \hline
\multicolumn{1}{|c|}{\multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Brzorezni\\ čelik\end{tabular}}} & \multicolumn{1}{c|}{Sapunica}           & \multicolumn{1}{c|}{25-40 (m/min)}          & \begin{tabular}[c]{@{}c@{}}čelik do \\ 50 kp/mm$^{2}$\end{tabular}                                                                      & 0,11 & 0,16 & 0,22 & 0,25 & 0,3  & 0,4  \\ \cline{2-10} 
\multicolumn{1}{|c|}{}                                                                           & \multicolumn{1}{c|}{Sapunica} & \multicolumn{1}{c|}{25-32 (m/min)}          & \begin{tabular}[c]{@{}c@{}}lijevano\\ željezo\\ do 18 kp/mm$^{2}$\end{tabular}                                                                           & 0,1  & 0,14 & 0,18 & 0,2  & 0,3  & 0,4  \\ \cline{2-10} 
\multicolumn{1}{|c|}{}                                                                           & \multicolumn{1}{c|}{Suho}               & \multicolumn{1}{c|}{20-35 (m/min)}          & \begin{tabular}[c]{@{}c@{}}lijevano\\ željezo\\ do 18 kp/mm$^{2}$\end{tabular}                                                                           & 0,16 & 0,25 & 0,3  & 0,35 & 0,45 & 0,5  \\ \hline
\end{tabular}%
}
\end{table}
\FloatBarrier
...
\begin{itemize}
\item s$<$10 mm, D = 20 s, h = 50 - 80 mm
\item s$<$3 mm, D = 28 s, h = 15 - 20 mm
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item Frekvencije vibracije f = 2000 - 2500 min$^{-1}$
\item Prednji kut $\gamma = 6 -7^{\circ}$
\item Nagib noževa $\varphi = 24 - 30 ^{\circ}$
\item Hod noža 2 - 3 mm
\end{itemize}
Koriste se za odsjecanje raznih kontura s radijusom r$_{min}$ = 15 mm, a izrezuje se prema ucrtanju na limu do 3 mm debljine.
\begin{figure}[!h]
\centering
...
Profile možemo rezati na posebnim uređajima konstuiranim specijalno za te svrhe. U stvarnosti, to su škare, koje u svojim noževima imaju razne otvore, ovisno o profilu koji mogu rezati. Postoje uređaji za rezanje profila veličine $\square$ 100; I profil 16 itd. U takvim škarama postoje i kratke škare za rezanje manjih rezova lima.\par
